...
<%--
  ...
  2. request     : HttpServletRequest : 응답 전까지 접근 가능하다. - 한번 응답받으면 끗!
...
<%--
  JSP Bind 영역의 우선 순위
  1. 동일한 이름의 속성(Attribute)이 여러 영역에 동시에 존재하는 경우 우선적으로 사용되는 경우가 ....
  2. 높은 순위                           낮은 순위
...
<body>
  ...
  <%
    List<Book> books = Arrays.asList(
        ...
        new Book("홍길동전", "허균", 20000),
        new Book("데미안", "조정래", 15000)
        );
