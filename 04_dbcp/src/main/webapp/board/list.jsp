...
<body>
  ...
  <div>
    <a class="sortD" href="${contextPath}/board/list.brd?page=1&sort=DESC&display=${display}">내림차순</a>
    <span>|</span>
    <a class="sortD" href="${contextPath}/board/list.brd?page=1&sort=ASC&display=${display}">오름차순</a>
  </div>
